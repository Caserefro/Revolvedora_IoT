...
def Response(operation_code, JsonDataReceived):
    ...
    elif operation_code == OP_LEVEL_CONTROL:
        return handle_LEVEL_SETPOINT_CONTROL(JsonDataReceived)
    elif operation_code == OP_OPENING_PERCENTAGE_SETPOINT_CONTROL:
        return handle_OPENING_PERCENTAGE_SETPOINT_CONTROL(JsonDataReceived)
...
def handle_LEVEL_SETPOINT_CONTROL(JsonDataReceived):
    print(JsonDataReceived)
    print("handle_LEVEL_SETPOINT_CONTROL")
    return "handle_LEVEL_SETPOINT_CONTROL"
...
def handle_OPENING_PERCENTAGE_SETPOINT_CONTROL(JsonDataReceived):
    print(JsonDataReceived)
    return "handle_OPENING_PERCENTAGE_SETPOINT_CONTROL"
...
def handle_SENSOR_RECORDS(JsonDataReceived):
    ...
    if device.device_type == "Flowmeter":
        ...
        records_data = [{"time": record.ValveRecords.time, "valve_value": record.ValveRecords.valve_value} for record in
                        records]
