...
void Package_OP_DEVICE_SYNC(JsonDocument &JsonPackagetoSend, String &PackagetoSend, int ID_DEVICE, String &DEVICE_TYPE, String &TAG, String &PLACE, String &DEVICE_DESCRIPTION) {  //Client used for request that dont add any special parameters.
  ...
  JsonPackagetoSend["Description"] = DEVICE_DESCRIPTION;
  serializeJson(JsonPackagetoSend, PackagetoSend);
  Serial.println("PackagetoSend");
  Serial.println(PackagetoSend);
}

void OP_DEVICE_SYNC_Wrapper(int ID_DEVICE, String &DEVICE_TYPE, String &TAG, String &PLACE, String &DEVICE_DESCRIPTION) {
  String response = "";
  String Package = "";
  JsonDocument doc;
  Package_OP_DEVICE_SYNC(doc, Package, ID_DEVICE, DEVICE_TYPE, TAG, PLACE, DEVICE_DESCRIPTION);
